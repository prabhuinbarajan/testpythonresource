...
from qube.src.api.swagger_models.testpythonresource import VersionModel
...
class TestPythonResourceItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(TestPythonResourceItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['TestPythonResource'],
            'description': 'TestPythonResource Version operation',
