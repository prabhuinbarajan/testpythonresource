...
from qube.src.api.testpythonresourcecontroller import TestPythonResourceController
from qube.src.api.testpythonresourcecontroller import TestPythonResourceItemController
from qube.src.api.versioncontroller import TestPythonResourceItemVersionController
...
api.add_resource(TestPythonResourceItemVersionController, '/v1/testpythonresource/version')
api.add_resource(TestPythonResourceController, '/v1/testpythonresource')
api.add_resource(TestPythonResourceItemController, '/v1/testpythonresource/<string:entity_id>')
