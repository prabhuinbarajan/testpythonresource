...
HELLO_WITH_ID = "/v1/testpythonresource/{}"
HELLO = "/v1/testpythonresource"
...
class TestTestPythonResourceController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("before class")
    ...
    def setupDatabaseRecords(self):
        with patch('mongomock.write_concern.WriteConcern.__init__',
                   return_value=None):
            data = TestPythonResource(name='test_record')
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_put_testpythonresource_item(self, *args, **kwargs):
        ...
        updated_record = TestPythonResource.query.get(entity_id)
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_put_testpythonresource_item_non_found(self, *args, **kwargs):
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_get_testpythonresource(self, *args, **kwargs):
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_get_testpythonresource_item_not_found(self, *args, **kwargs):
    ...
    def test_delete_testpythonresource_item(self, *args, **kwargs):
        id_to_delete = str(self.data.mongo_id)
        rv = self.test_client.delete(HELLO_WITH_ID.format(id_to_delete),
                                     headers=self.headers)
        self.assertTrue(rv._status_code == 204)
        deleted_record = TestPythonResource.query.get(id_to_delete)
        self.assertIsNone(deleted_record)

    @patch('mongomock.write_concern.WriteConcern.__init__', return_value=None)
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(system_user_auth_response(), 200))
    def test_delete_testpythonresource_item_notfound(self, *args, **kwargs):
    ...
    def test_get_testpythonresource_not_authorized(self, *args, **kwargs):
        rv = self.test_client.get(HELLO, headers=self.headers)
    ...
    def test_get_testpythonresource_master_token(self, *args, **kwargs):
        rv = self.test_client.get(HELLO, headers=self.headers)
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(no_auth_response(), 401))
    def test_get_testpythonresource_no_authorization(self, *args, **kwargs):
