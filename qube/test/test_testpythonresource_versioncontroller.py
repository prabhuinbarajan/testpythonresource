...
HELLO_VERSION = "/v1/testpythonresource/version"
...
class TestTestPythonResourceVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_testpythonresource_default_version(self, *args, **kwargs):
    ...
    def test_testpythonresource_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
